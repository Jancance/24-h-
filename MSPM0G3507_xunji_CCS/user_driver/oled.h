...
/*
 * OLED wiring:
 *   OLED_SDA -> PA0, I2C0_SDA
 *   OLED_SCL -> PA1, I2C0_SCL
...
#define OLED_TEXT_FONT_SIZE 16U
#define OLED_TEXT_MAX_ROW   4U
#define OLED_TEXT_MAX_COL   16U
 ...
 *
 * @param row 第几行，从 1 开始，范围 1~4
 * @param col 第几列，从 1 开始，范围 1~16
 * @param chr 字符串指针，指向以 '\0' 结尾的字符串，例如 "hello"
 * @param len 最多显示几个字符，例如 "hello" 就填 5
 *
 * @note
 * - 固定使用 16 号字体，一行最多 16 个英文字符
 * - 例如 OLED_ShowString(1, 2, "hello", 5)，表示第 1 行第 2 列显示 hello
 * - 仅支持 ASCII 可显示字符范围 ' ' ~ '~'
 */
